    ...
    <div class="container change-section">
        ...
        <div class="row h-100 align-self-center">
            ...
            <div class="col-md-12 text-center">
                ...
                if ($isModify) {
                    if (empty($_GET["mod"])) {
                        echo "Merci de saisir un numéro d'utilisateur";
                        die;
                    }
                    if (!is_numeric($_GET["mod"])) {
                        echo "Merci de saisir un numéro d'utilisateur correct";
                        die;
                    }
                    ...
                    if ($infos["role"] == 1) {
                        echo "Vous ne pouvez pas éditer le profil d'un administrateur";
                        die;
                    }
                }
